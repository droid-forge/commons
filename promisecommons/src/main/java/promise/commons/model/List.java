...
import promise.commons.model.function.FilterFunction2;
import promise.commons.model.function.GroupFunction;
import promise.commons.model.function.GroupFunction2;
...
public class List<T> extends ArrayList<T> {
   ...
   */
  public <U> List<T> joinOn(List<U> uList, JoinFunction<? super T, ? super U> function) {
    List<T> ts = new List<>();
  ...
  public <U> List<T> join(List<U> uList, Combiner<? super U, T> function) {
   ...
   * @param reverse  flags to compare equality or no equality
  ...
  public <U, K> List<T> reduce(
      List<U> uList, final FilterFunction2<? extends K, ? super U, ? super T> function, final boolean reverse) {
   ...
   * @return
   */
  public <K, MERGE> List<Pair<T, K>> mergeWith(List<K> list, final FilterFunction2<? extends MERGE, ? super K, ? super T> function) {
   ...
   * @return
   */
  public <U> List<T> reduce(List<U> list, JoinFunction<? super T, ? super U> function) {
    List<T> ts = new List<>();
